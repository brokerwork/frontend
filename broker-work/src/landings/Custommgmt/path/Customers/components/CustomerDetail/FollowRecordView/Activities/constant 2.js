...
export const OPREATE_WAY = {
  ...
  BILL: i18n['customer.detail.opreate_type_bill'],
  CONTRACTS: i18n['customer.detail.opreate_type_contract'],
  REFUND: i18n['customer.detail.opreate_type_refund']
};
