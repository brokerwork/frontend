...
export default class ActionBar extends Component {
  ...
  modifyParams = (field, v) => {
    ...
    const __obj = this.handleParams(field, v);
    modifyParams({
      ...params,
      ...__obj
    });
  ...
  modifyMoreOptions = (field, v) => {
    ...
    const options = this.handleParams(field, v);
    this.setState({ moreOptions: { ...moreOptions, ...options } });
  };

  handleParams = (field, v) => {
    let __obj = {
  ...
  fuzzyItemOptions = [
    ...
    { label: i18n['setting.log.object_id'], value: 'objectId' }
  ];
  ...
  renderMoreOptions = () => {
    ...
    console.log('report logType', logType);
    return (
