...
import ExtraServiceAlert from '../ExtraServiceAlert';
import cs from './PageWraper.less';
...
export default class PageWraper extends PureComponent {
  ...
  render() {
    ...
    return (
      <div
        className={`${cs['container']} ${containerClass}`}
        id="page-container"
      >
        <div className={cs['container-innerbox']}>
          {realeseNoticeData ? (
            <BannerNotice
              onHide={closeRealeseNotice}
              bsStyle={'warning'}
              content={realeseNoticeData}
            />
          ) : (
            undefined
          )}
          ...
          />
          <div
            className={`${cs['content']} ${className ? className : ''}`}
            id="page-content"
          >
            <OpacityWrapper appear>
              {bannerNoticeData ? (
                <BannerNotice
                  onHide={closeBannerNotice}
                  className={cs['box-success']}
                  {...bannerNoticeData}
                />
              ) : (
                undefined
            ...
            <div
              className={`${
                rebateContent ? cs['rebate-content-bg'] : cs['content-bg']
              }`}
            >
              {userRightReady ? children : undefined}
            </div>
          </div>
          <Footer brandInfo={brandInfo} {...footer} {...this.props} />
        </div>
