...
class AddSales extends React.Component<P, S>{
    ...
    render() {
        ...
        return (
            <Modal ref="addsalesmodal" title={this.state.isModify ? '修改目标' : '新增目标'}>
                            ...
                            <Table  bordered  hover className="sale-table">
                                <thead>
                                    <tr>
                                        ...
                                        <td>第二季度<FormControl type="text" ref="secondquarterGoal" defaultValue={getValue(secondQuarterRecord, 'quarterGoal') } /></td>
                                        <td>第三季度<FormControl type="text" ref="thirdquarterGoal" defaultValue={getValue(thirdQuarterRecord, 'quarterGoal') } /></td>
                                        <td>第四季度<FormControl type="text" ref="forthquarterGoal" defaultValue={getValue(fourthQuarterRecord, 'quarterGoal') } /></td>
                                        
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <th>{this.state.year+'-01'}<FormControl type="text" ref="firstquarterfirstGoal" defaultValue={getValue(firstQuarterRecord, 'firstGoal') } /></th>
                                    ...
                                    <tr>
                                        <th>{this.state.year+'-02'}<FormControl type="text" ref="firstquartersecondGoal" defaultValue={getValue(firstQuarterRecord, 'secondGoal') } /></th>
                                    ...
                                    <tr>
                                        <th>{this.state.year+'-03'}<FormControl type="text" ref="firstquarterthirdGoal" defaultValue={getValue(firstQuarterRecord, 'thirdGoal') } /></th>
...
let AddSales = connect(mapStateToProps, null, null, { withRef: true })(AddSales);
export {AddSales};
