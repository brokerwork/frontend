...
import AssetsAccountReduxForm, { ASSETS_ACCOUNT_FORM } from './form';
import { transInitValues, transSubmitData } from '../../utils';
import _ from 'lodash';
export default class AssetsAccount extends PureComponent {
  onSave = () => {
    const { submitForm } = this.props;
    submitForm(ASSETS_ACCOUNT_FORM);
  };
  onReset = () => {
    const { resetForm } = this.props;
    resetForm(ASSETS_ACCOUNT_FORM);
  };
  onSubmit = values => {
