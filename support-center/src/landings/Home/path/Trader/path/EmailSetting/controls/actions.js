...
const PRE_FIX = 'TRADER_EMAIL_SETTING_';
...
export const getEmailList = createAction(
  GET_EMAIL_LIST,
  () => post({
...
export const getEmailProvider = createAction(
  GET_EMAIL_PROVIDER,
  () => get({
...
export const _setEmailTarget = createAction(
  SET_EMAIL_TARGET,
  (target) => target
);
...
export const getEmailDefaultLanguage = createAction(
...
export const updateEmailDefalutLanguage = createAction(
  UPDATE_EMAIL_DEFAULT_LANGUAGE,
  (lang) => get({
...
export const sendTestEmail = createAction(
  ...
  (email) => post({
    ...
    data: {
      ...
      type: 'MAIL',
      userId: 'SC',
      templateType: 'TW_TEST_SMTP',
      ...email
    }
  })
);

export const _storeSelectedTemplate = createAction(
  STORE_SELECTED_TEMPLATE,
  (data) => data
);

export const batchUpdateTemplateEmail = createAction(
  BATCH_UPDATE_TEMPLATE_EMAIL,
  (templateIds, configId) => post({
...
export const getTemplateDetail = createAction(
  GET_TEMPLATE_DETAIL,
  (type) => get({
...
export const getEmailDefaultTemplate = createAction(
  GET_EMAIL_DEFAULT_TEMPLATE,
  (templateType, lang) => post({
...
export const getEmailNewTemplateList = createAction(
...
export const batchResetEmailTemplates = createAction(
  BATCH_RESET_EMAIL_TEMPLATES,
  (ids) => post({
