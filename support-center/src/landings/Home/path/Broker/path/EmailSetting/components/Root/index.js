...
import TemplateEmail from '../../containers/TemplateEmail';
    ...
    return showTempViewer ? (
      ...
      <ContentWrapper header={i18n['left.menu.email.setting']}>
        <Tab activeKey={activeKey} onChange={this.onChange}>
          ...
          <Tab.Panel title={i18n['email.setting.template.title']} eventKey="template">
            <TemplateEmail toggleTempViewer={this.toggleTempViewer} />
          </Tab.Panel>
        </Tab>
      </ContentWrapper>
    );
